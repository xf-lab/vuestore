    ...
    <v-layout align-start>
        <v-flex>
            <v-toolbar color="white">
                ...
                ></v-divider>
                <v-spacer></v-spacer>
                <v-text-field class="text-xs-center" v-model="search" append-icon="search" v-if="!nuevoVenta"
                label="Búsqueda" single-line hide-details></v-text-field>
                <v-spacer></v-spacer>
                <v-btn color="primary" v-if="nuevoVenta==0" @click="mostrarNuevo()" dark class="mb-2">Nuevo</v-btn>
                ...
                <v-dialog v-model="adModal" max-width="290">
                    <v-card>
                        ...
                        <v-card-actions>
                            ...
                            <v-btn v-if="adAction == 1" @click="anularVenta" color="orange darken-4">
                                Anular
                            </v-btn>
                        </v-card-actions>
                    </v-card>
            ...
            >
                <template v-slot:item="props">
                    <tr>
                        <td>
                            <v-icon 
                                @click="listarDetalle(props.item)"
                                class="mr-2"
                            >remove_red_eye
                            </v-icon>
            ...
            <v-container grid-list-sm class="pa-4 white" v-if="nuevoVenta">
                <v-layout row wrap>
                    ...
                    <v-flex xs12 sm8 md8 lg8 xl8>
                        <v-autocomplete :items="personas" v-model="editedItem.persona" label="Cliente">
                        </v-autocomplete>
                    </v-flex>
                    <v-flex xs12 sm4 md4 lg4 xl4>
                            ...
                            >
                                <template v-slot:item="props">
                                    <tr>
                                        ...
                                        <td class="text-xs-center"><v-text-field v-model="props.item.descuento"></v-text-field></td>
                    ...
                    <v-flex xs12 sm12 md12 lg12 xl12 d-flex mt-4 style="justify-content: space-evenly;">
                        <v-btn color="blue darken-1" @click="cierraNuevoVenta">Cancelar</v-btn>
                        <v-btn color="success" @click="guardarVenta" v-if="!editItem">Guardar</v-btn>
                    </v-flex>
                </v-layout>
            </v-container>
        </v-flex>
        ...
        computed: {
            calcularTotal(){
                ...
                this.detalles.map( function(x) {
                    suma = (x.precio * x.cantidad) - x.descuento;
                    total += suma;
                });
                return total;            
            }
